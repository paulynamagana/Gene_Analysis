...
knit: (function(input_file, encoding) { output_dir = "./";
 ...
 encoding=encoding,
 output_file=file.path(dirname(input_file), output_dir, 'GSE32866 results.pdf'))})
---
...
baseDir <- './GSE32866/' #if workingon another directoty

gse=getGEO(filename="./GSE32866_series_matrix.txt.gz")
dim(gse)
